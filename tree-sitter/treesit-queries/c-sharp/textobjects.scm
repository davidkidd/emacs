;; I can't figure out how to get evil-textobj-tree-sitter
;; to use this file so just copy it into the relevant
;; folder that the evil-textobj installs to and looks for it
(class_declaration
...
(enum_declaration
  body: (enum_member_declaration_list) @class.inner)  @class.outer
...
(method_declaration
 body: (arrow_expression_clause) @function.inner) @function.outer
