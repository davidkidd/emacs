;; Make compilation window split the current window and appear at the bottom
(setq display-buffer-alist
      '(("\\*compilation\\*"
         (display-buffer-reuse-window display-buffer-in-direction)
         (direction . below)
         (window-height . 15)  ; Set a fixed height of 15 lines
         (reusable-frames . visible))))

;; Automatically switch to the compilation buffer
